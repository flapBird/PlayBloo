...
export function HomeGuideFeature() {
  ...
  return <Link href={guidePath(topic)} className={styles.homeFeature}>
    ...
    <div className={styles.homeFeatureCopy}><span className={styles.eyebrow}>From the guide desk</span><h2>{topic.name}</h2><p>Release details, confirmed changes and what to know before you play.</p><span className={styles.cardBottom}>Explore the guide <ArrowRight size={14} /></span></div>
  </Link>;
}
